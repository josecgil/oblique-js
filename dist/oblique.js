...
(function() {
  var DirectiveCollection, DirectiveProcessor, Element, Error, JSON, NamedParams, Oblique, ObliqueError, Param, Template, TimedDOMObserver,
  ...
  Template = (function() {
    ...
    Template.prototype.setContent = function(templateContent) {
      this.templateContent = templateContent;
      return this.compiledTemplate = Handlebars.compile(this.templateContent);
    };

    Template.prototype.parse = function(model) {
