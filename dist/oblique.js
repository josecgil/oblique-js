...
(function() {
  var ArrayParam, DOMProcessor, DataModelVariable, Directive, DirectiveCollection, Element, EmptyParam, LocationParser, Memory, Oblique, ObliqueError, Param, ParamCollection, RangeParam, SingleParam, Template, TemplateFactory, TimedDOMObserver,
  ...
  LocationParser = (function() {
    function LocationParser(locationHash) {
      var ch, currentParam, i, isInsideValue, len1;
      locationHash = locationHash.replace("#", "") + "&";
      this.hashParams = [];
      currentParam = "";
      isInsideValue = false;
      for (i = 0, len1 = locationHash.length; i < len1; i++) {
        ch = locationHash[i];
        if (ch === ']' || ch === ')') {
          isInsideValue = false;
        }
  ...
  ParamCollection = (function() {
    function ParamCollection(locationHash) {
      var hashParam, i, len1, locationParser, param, ref;
      this.removeAll();
