...
(function() {
  ...
  CallbackCollection = (function() {
    ...
    CallbackCollection.prototype.each = function(fnAtEachCallback) {
      var callBack, callbackName, _results;
      _results = [];
      for (callbackName in this._callbacksByName) {
        callBack = this.getCallbackByName(callbackName);
        _results.push(fnAtEachCallback(callbackName, callBack));
      }
      return _results;
    };
