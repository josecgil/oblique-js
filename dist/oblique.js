...
(function() {
  var ArrayParam, DOMProcessor, DataModelVariable, Directive, DirectiveCollection, Element, EmptyParam, Memory, Oblique, ObliqueError, Param, ParamCollection, RangeParam, SingleParam, Template, TemplateFactory, TimedDOMObserver,
  ...
  Directive = (function() {
    function Directive(name, callback, isGlobal) {
      this.name = name;
  ...
  DirectiveCollection = (function() {
    ...
    DirectiveCollection.prototype.each = function(callback) {
      var index, key, value, _ref, _results;
      index = 0;
      _ref = this._directives;
      _results = [];
      for (key in _ref) {
        value = _ref[key];
  ...
  DOMProcessor = (function() {
    ...
    DOMProcessor.prototype._callOnIntervalOnCurrentDirectives = function() {
      var directive, directiveInstanceData, _i, _len, _ref, _results;
      _ref = this._directiveInstancesData;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        directiveInstanceData = _ref[_i];
        directive = directiveInstanceData.instance;
        if (directive.onInterval) {
          _results.push(directive.onInterval());
        } else {
          _results.push(void 0);
        }
      }
