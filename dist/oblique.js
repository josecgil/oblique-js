...
(function() {
  var DirectiveCollection, DirectiveProcessor, Element, Error, JSON, NamedParams, Oblique, ObliqueError, Param, StringList, Template, TemplateFactory, TimedDOMObserver,
  ...
  JSON = (function() {
    ...
    JSON.parseString = function(jsonString) {
      return new JSON(jQuery.parseJSON(jsonString));
    };
  ...
  StringList = (function() {
    function StringList(values, separator) {
      if (separator == null) {
        separator = ",";
      }
      this._values = values.split(separator);
    }

    StringList.prototype.toStringArray = function() {
      return this._values;
    };

    StringList.prototype._valueToInt = function(value) {
      var number;
    ...
    StringList.prototype.toIntArray = function() {
      var value, _i, _len, _ref, _results;
      _ref = this._values;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        value = _ref[_i];
        _results.push(this._valueToInt(value));
      }
      return _results;
    };
